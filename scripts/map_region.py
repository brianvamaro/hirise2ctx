...
# Re-exported so every existing caller keeps working. These live in a STANDARD-LIBRARY-ONLY
# module because the tools that repair and verify a shipped generation must not need torch
# -- see src/map_manifest.py's docstring for what that cost us.
from src.map_manifest import (MANIFEST_NAMES, merge_manifest,  # noqa: F401
                              tile_result_rows, tile_sidecars, write_json_atomic)
