...
|---|---|---|
| [PLAN_Rebuild.md](PLAN_Rebuild.md) | **The batched v2 rebuild** — executes the 12-step DAG in [docs/CODE_REVIEW_AUDIT_2026-08-06.md](docs/CODE_REVIEW_AUDIT_2026-08-06.md): commands, roots, verification gates, abort conditions, and the local/Sherlock split | **EXECUTING — steps 1–11 DONE and verified (2026-08-20 → 25), step 12 next.** Rich prevalence **0.373272** as predicted; the frozen recipe transfers unchanged (per-image AUC −0.0087, inside one SE); **A1's skill cost collapsed −0.024 → −0.0024**. Step 11 shipped **both arms at 26/26**, 156/156 rasters sha256-verified, 26/26 cell-for-cell co-registered (DECISIONS 2026-08-24d → 2026-08-25g). ⚠ **η² is NOT yet re-derived** — map-time quantity, first item of step 12; do not pair it with the old 0.141. Four design decisions ruled in DECISIONS 2026-08-18b, three more 2026-08-19: build **in place** gated on the SHA-256 backup pass, land the `rasterio.open` hoist before step 11, **FM path only** (no GBM sweep / W1 atlas). A **WAYPOINT** — v3 (BoulderNet retrain + more diverse locations) forces another rerun regardless |
